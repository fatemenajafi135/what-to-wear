...
def upgrade() -> None:
    ...
    op.create_table('preference_signal_dismissal',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('user_id', sa.UUID(), nullable=False),
    ...
    op.create_index(op.f('ix_preference_signal_dismissal_user_id'), 'preference_signal_dismissal', ['user_id'], unique=False)
