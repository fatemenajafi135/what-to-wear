<!-- refined from: Color theory - Wikipedia.html -->
...
> The bluish white (kāraṇḍava) color, is made up of the white and the blue, and the yellowish white color (pāṇḍu) of the white and the yellow. The lotus (padma) color is made up of the white and the red, and the green (harit) color, of the yellow and the blue. The dark red (kāṣāya) color is made up of the blue and the red, and the pale-red (gaura) color of the red and the yellow. These are the derivative colors. Besides these there are [many] minor colors which may be made up of three or four [original] colors.
...
![Page from 1826 A New Practical Treatise on the Three Primitive Colours Assumed as a Perfect System of Rudimentary Information by Charles Hayter](Color theory - Wikipedia_files/Color_diagram_Charles_Hayter.jpg)
...
![Munsell's 1905 color system represents colors using three color-making attributes, value (lightness), chroma (saturation), and hue.](Color theory - Wikipedia_files/Munsell-system.svg.png)
...
![Additive color mixing (such as in a computer)](Color theory - Wikipedia_files/AdditiveColor.svg.png)

*Additive color mixing (such as in a computer)*

![Subtractive color mixing (such as in a printer)](Color theory - Wikipedia_files/SubtractiveColor.svg.png)
...
![Primary, secondary, and tertiary colors of the RYB color model](Color theory - Wikipedia_files/Color_star-en_(tertiary_names).svg.png)
...
![Chevreul's 1855 ](Color theory - Wikipedia_files/Chevreul's_RYB_chromatic_diagram.png)
...
![Georg Christoph Lichtenberg. Göttingen, 1775, plate III.](Color theory - Wikipedia_files/Georg_Christoph_Lichtenberg._Göttingen,_1775,_plate_III.jpg)

*Georg Christoph Lichtenberg. Göttingen, 1775, plate III.*

![Ignaz Schiffermüller, Versuch eines Farbensystems (Vienna, 1772), plate I.](Color theory - Wikipedia_files/020_schiffermueller1.jpg)
...
![{\displaystyle {\text{Color harmony}}=f(\operatorname {Col} 1,2,3,\dots ,n)\cdot (ID+CE+CX+P+T)}](./Color theory - Wikipedia_files/44566f02b0fc6d47cd63ccbf8b2fd4542b57fc04)
