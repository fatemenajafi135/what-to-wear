...
SYSTEM_PROMPT = (
    ...
    "dress + shoes) and adds outerwear when the weather rule calls for it. Use "
    "exactly ONE pair of footwear, and at most one bottom. A dress, suit, gown, or "
    "jumpsuit is worn on its own — never pair it with separate trousers or a skirt "
    "(you may still layer outerwear or a cardigan over it).\n"
