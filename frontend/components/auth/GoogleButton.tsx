...
/**
 * design/design-system.md §9's open question (also handoff trap #4): the
 * exact treatment of the Google "G" is unspecified beyond "standard
 * four-colour mark" — used here as literally as that phrase allows, the
 * mark's own official four brand colors, no deviation recorded because none
 * was made.
 */
export function GoogleButton({ onClick, disabled }: GoogleButtonProps) {
  return (
    <Button variant="outline" width="stretch" onClick={onClick} disabled={disabled}>
